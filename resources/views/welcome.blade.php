...
<body>
    <div class="background">
        <img src="{{asset('storage/image/logo.png')}}" alt="">
    </div>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <div class="cta-buttons">
                <a href="{{ route('login') }}" class="cta-btn btn-primary">
                ...
                <a href="{{ url('/equip_avail') }}" class="cta-btn btn-secondary">Browse Equipment</a>
            </div>
        </div>
    </section>
