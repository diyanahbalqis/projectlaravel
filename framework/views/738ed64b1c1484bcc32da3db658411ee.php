...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/loan/create.css')); ?>" >
...
<form method="POST" action="<?php echo e(route('loan.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>  
        ...
        <select name="equipment_id" id="equipment_id" class="form-control" required>
            ...
            <?php $__currentLoopData = $equipment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($equip->id); ?>">
                    <?php echo e($equip->name); ?> (<?php echo e($equip->equipment_no); ?>)
                </option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
        <?php $__errorArgs = ['equipment_id'];
...
<?php echo $__env->make(Auth::user()->role == 'admin' ? 'layouts.app' : 'layouts.userapp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\projectlaravel\resources\views/loan/create.blade.php ENDPATH**/ ?>