...
<title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - TechRent Pro</title>
...
<!-- App CSS -->
<link rel="stylesheet" href="<?php echo e(asset('css/userapp.css')); ?>">
...
<div class="main-content" id="mainContent">
    ...
    <div class="topbar">
        ...
        <div class="topbar-right d-flex align-items-center gap-3">
            ...
            <!-- Notifications -->
            <div class="dropdown">
    <a class="notification-btn position-relative" data-bs-toggle="dropdown" href="#" id="notificationBtn">
        <i>🔔</i>
    ...
    <ul class="dropdown-menu dropdown-menu-end" id="notifList" style="width:320px">
        ...
        <li><span class="dropdown-item text-muted">Loading...</span></li>
            ...
            <!-- User Profile -->
            <div class="dropdown">
                <a class="user-profile dropdown-toggle" data-bs-toggle="dropdown" href="#">
        ...
        try {
            ...
            if (data.notifications.length) {
                data.notifications.forEach(n => {
                    html += `
                        <li>
                            <a href="#" class="dropdown-item notif-item" data-id="${n.id}">
...
<?php /**PATH C:\laragon\www\projectlaravel\resources\views/layouts/userapp.blade.php ENDPATH**/ ?>